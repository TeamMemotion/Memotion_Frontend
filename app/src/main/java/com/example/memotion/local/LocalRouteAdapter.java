...
public class LocalRouteAdapter extends RecyclerView.Adapter<LocalRouteAdapter.ViewHolder> {

    private LocalGuideActivity localGuideActivity;
    private LocalGuideSearchActivity localGuideSearchActivity;
    ItemRouteBinding itemRouteBinding;
    private Context context;
    private ArrayList<LocalGuideGetResponse.Result> routeList;

    public LocalRouteAdapter(LocalGuideActivity localGuideActivity) {
        this.localGuideActivity = localGuideActivity;
    }

    public LocalRouteAdapter(LocalGuideSearchActivity localGuideSearchActivity) {
        this.localGuideSearchActivity = localGuideSearchActivity;
    }

    public void setRouteList(ArrayList<LocalGuideGetResponse.Result> result) {
        this.routeList = result;
    }

    @NonNull
    @Override
    public LocalRouteAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LocalRouteAdapter.ViewHolder holder, int position) {
        if (holder instanceof LocalRouteAdapter.ViewHolder) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (itemClickListener != null) {
                        itemClickListener.onItemClick(routeList.get(position));
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(LocalGuideGetResponse.Result result) {
            ...
            itemRouteBinding.routeTitle.setText(result.getRouteName());
